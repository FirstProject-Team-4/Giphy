 ...
 * @returns {Promise<Array>} - A promise that resolves to an array of user's uploads.
 */
 ...
 * @returns {Promise<Array>} A promise that resolves to an array of trending data.
 */
 ...
 * @returns {object} - The object with the matching ID.
 */
...
/**
 * Loads favorite GIFs.
 * @returns {Promise<Array<Object>>} A promise that resolves to an array of favorite GIFs.
 */
